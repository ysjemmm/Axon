...
md.renderer.rules.fence = function (tokens, idx) {
  ...
  if (enableEnhance) {
    return `<div class="axon-codeblock my-1.5 rounded-2xl overflow-hidden" style="border:1px solid var(--axon-code-border,rgba(128,128,128,0.18));background:var(--axon-code-bg,rgba(127,127,127,0.05))"${enhanceAttr}>
    <pre class="px-3 py-2 overflow-auto max-h-96 m-0" style="background:transparent"><code class="text-[12px] leading-5 font-mono hljs" style="color:var(--vscode-editor-foreground,var(--hl-text,#c9d1d9))">${highlightedCode}</code></pre>
  </div>\n`;
  }
  ...
  return `<div class="axon-codeblock my-1.5 rounded-2xl overflow-hidden" style="border:1px solid var(--axon-code-border,rgba(128,128,128,0.18));background:var(--axon-code-bg,rgba(127,127,127,0.05))"${previewAttr}>
    <div class="flex items-center justify-between px-3 pt-1.5 pb-0 text-[11px] text-muted-foreground/80" style="background:transparent;border-bottom:none">
      <span class="font-medium tracking-[0.01em]" style="color:var(--vscode-descriptionForeground,rgba(120,120,120,0.95))">${displayLang === "code" ? "text" : displayLang}</span>
    ...
    <pre class="px-3 pt-1 pb-2 overflow-auto max-h-96 m-0" style="background:transparent"><code class="text-[12px] leading-5 font-mono hljs" style="color:var(--vscode-editor-foreground,var(--hl-text,#c9d1d9))">${highlightedCode}</code></pre>
  </div>\n`;
};
