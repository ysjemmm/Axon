 ...
 */
export interface TurnHandlerContract {
 ...
 */
export const DEFAULT_HANDLER_CONTRACTS = {
  requestContextHandler: {
    writable: ["startedAt", "baseMessages"],
  } satisfies Pick<RequestHandlerContract, "writable">,
  turnContextHandler: {
    writable: ["startedAt", "effectiveMessages", "runtimeEvents", "toolContexts"],
  } satisfies Pick<TurnHandlerContract, "writable">,
  llmHandler: {
